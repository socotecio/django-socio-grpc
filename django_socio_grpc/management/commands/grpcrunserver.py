...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('address', nargs='?', default='[::]:{}'.format(GRPC_CHANNEL_PORT), help='Optional address for which to open a port.' )
        parser.add_argument('--max-workers', type=int, default=10, dest='max_workers', help='Number of maximum worker threads.' )
        parser.add_argument('--reflection',  default='', dest='reflection', help='Start gRPC Server Reflection.' )
        parser.add_argument('--dev', action='store_true', dest='development_mode',
            help=(
