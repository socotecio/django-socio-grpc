...
class EnumControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BasicEnumRequest = channel.unary_unary(
                ...
                _registered_method=True)
        self.BasicEnumRequestInSerializerOut = channel.unary_unary(
                '/myproject.fakeapp.EnumController/BasicEnumRequestInSerializerOut',
                request_serializer=django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.EnumBasicEnumRequestInSerializerOutRequest.SerializeToString,
                response_deserializer=django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.EnumServiceOnlyOneFieldResponse.FromString,
                _registered_method=True)
...
class EnumControllerServicer(object):
    ...
    def BasicEnumRequestInSerializerOut(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EnumControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BasicEnumRequestInSerializerOut': grpc.unary_unary_rpc_method_handler(
                    servicer.BasicEnumRequestInSerializerOut,
                    request_deserializer=django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.EnumBasicEnumRequestInSerializerOutRequest.FromString,
                    response_serializer=django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.EnumServiceOnlyOneFieldResponse.SerializeToString,
            ),
...
class EnumController(object):
    ...
    @staticmethod
    def BasicEnumRequestInSerializerOut(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/myproject.fakeapp.EnumController/BasicEnumRequestInSerializerOut',
            django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.EnumBasicEnumRequestInSerializerOutRequest.SerializeToString,
            django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.EnumServiceOnlyOneFieldResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
