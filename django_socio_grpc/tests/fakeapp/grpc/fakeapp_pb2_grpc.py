...
class ManyManyModelControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.List = channel.unary_unary(
                '/myproject.fakeapp.ManyManyModelController/List',
        ...
        self.Create = channel.unary_unary(
                '/myproject.fakeapp.ManyManyModelController/Create',
        ...
        self.Retrieve = channel.unary_unary(
                '/myproject.fakeapp.ManyManyModelController/Retrieve',
        ...
        self.Update = channel.unary_unary(
                '/myproject.fakeapp.ManyManyModelController/Update',
                request_serializer=django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.ManyManyModel.SerializeToString,
                response_deserializer=django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.ManyManyModel.FromString,
                )
        self.Destroy = channel.unary_unary(
                '/myproject.fakeapp.ManyManyModelController/Destroy',
...
def add_ManyManyModelControllerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'myproject.fakeapp.ManyManyModelController', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ManyManyModelController(object):
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/myproject.fakeapp.ManyManyModelController/List',
    ...
    def Create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/myproject.fakeapp.ManyManyModelController/Create',
    ...
    def Retrieve(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/myproject.fakeapp.ManyManyModelController/Retrieve',
    ...
    def Update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/myproject.fakeapp.ManyManyModelController/Update',
            django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.ManyManyModel.SerializeToString,
            django__socio__grpc_dot_tests_dot_fakeapp_dot_grpc_dot_fakeapp__pb2.ManyManyModel.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Destroy(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/myproject.fakeapp.ManyManyModelController/Destroy',
